...
function greeting()
{
	...
	var header = document.querySelector("#greeting");	// 1. Create header object to work with
	header.style.fontSize = "48pt";							// 2. Set the font size to something between 24-48
	...
	else
	{
		...
		else
		{
			...
			header.style.color = "darkblue";					// 6. Set a color for the greeting		
		}
	}
